export const translations = {
    nl: {
        ...
        checkAllAnswers: "Tijd om Rechter te Spelen!",
        ...
        roomDeleted: "Dit spel is verwijderd.",
        ...
        transPensDown: [
            ...
            { title: "STILTE IN DE ZAAL!", sub: "De jury begint aan het vonnis." },
        ...
        transCalculating: [
            ...
            { title: "BIEP BOEP!", sub: "De spanning stijgt, de processor ook." },
            ...
            { title: "MATRIX MODUS...", sub: "Zie je de groene cijfertjes ook?" },
            { title: "BOEKHOUDING...", sub: "De fiscus kijkt mee (grapje hoor)." },
            { title: "TEL-O-MATIC...", sub: "Onze nieuwste uitvinding berekent de winst." },
            { title: "SCORE-RAD...", sub: "Waar het stopt, weet niemand." },
            { title: "PUNTEN-REGEN...", sub: "Paraplu omhoog!" },
            { title: "CYBER-WISKUNDE...", sub: "Voor de gamers onder ons." },
    ...
    de: {
        ...
        tutorialVotingIntro: "Nach Ablauf der Zeit stimmt jeder über alle Antworten ab:",
        ...
        checkAllAnswers: "Zeit zum Richtern!",
        ...
        moreTime: "+10s Mehr Zeit",
        waitingForVotes: "Warten auf Stimmen...",
        verdictDecided: "Urteil gefällt!",
        approved: "✅ GENEHMIGT!",
        ...
        roomDeleted: "Dieses Spiel wurde gelöscht.",
